...
np.save('3DMM/3DMM_info.npy', {'mu_shape': mu_shape, 'b_shape': b_shape, 'sig_shape': shapeEV.reshape(-1),
                               'mu_exp': exp_info['mu_exp'], 'b_exp': exp_info['base_exp'],
                               'sig_exp': exp_info['sig_exp'], 'mu_tex': mu_tex,
                               'b_tex': b_tex, 'sig_tex': texEV.reshape(-1)})
